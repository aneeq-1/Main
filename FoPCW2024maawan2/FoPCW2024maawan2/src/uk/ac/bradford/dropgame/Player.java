...
public class Player extends Entity {
     ...
     *
     * @param maxEnergy the maximum energy of this Player, also used to set its
    ...
    /**
     * Changes the current energy value for this Player, setting it to the value
     * of maxEnergy.
     */
     ...
     * it. If the new value for player energy is larger than the maximum then
