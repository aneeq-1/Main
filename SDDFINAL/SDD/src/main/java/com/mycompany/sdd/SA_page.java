 ...
 * @author apple
 */
public class SA_page extends JFrame implements ActionListener { 
public SA_page() {
    setTitle("System Administrator Dashboard");
        setSize(800, 600);
        JPanel north_panel = new JPanel();
        JLabel title = new JLabel("Welcome System Administrator!");
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            if (command.equals("View Event")) {
                viewEvent_page newPageFrame = new viewEvent_page("SA");
                newPageFrame.setVisible(true);
            }else if (command.equals("Edit Event")) {
                editEvent_page newPageFrame = new editEvent_page("SA");
                newPageFrame.setVisible(true);
