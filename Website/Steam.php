...
<body>
    ...
    <table border="0">
        <tr>
            <td><a href="ItTakesTwo.html"><img src="Images/ItTakesTwo.webp" width="400" height="225" class="table-img"></a></td>
            <td><a href="FinalFantasyVII.html"><img src="Images/FinalFantasyVII.jpg" width="400" height="225" class="table-img"></a></td>
            <td><a href="GOWRagnarok.html"><img src="Images/GOWRagnarok.jpg" width="400" height="225" class="table-img"></a></td>
        </tr>
        <tr>
            <td class="game-name"><a href="ItTakesTwo.html">It Takes Two</a></td>
            <td class="game-name"><a href="FinalFantasyVII.html">Final Fantasy VII Remake Intergrade</a></td>
        ...
        <tr>
            <td><button class="add-to-basket" onclick="addToBasket('It Takes Two', 59.99)">Add to Basket</button></td>
            <td><button class="add-to-basket" onclick="addToBasket('Final Fantasy VII Remake Intergrade', 49.99)">Add to Basket</button></td>
            <td><button class="add-to-basket" onclick="addToBasket('God Of War: Ragnarok', 69.99)">Add to Basket</button></td>
        </tr>
        <tr>
            <td><a href="Rust.html"><img src="Images/Rust.webp" width="400" height="225" class="table-img"></a></td>
            <td><a href="LostArk.html"><img src="Images/LostArk.jpeg" width="400" height="225" class="table-img"></a></td>
        ...
        <tr>
            ...
            <td class="game-name"><a href="LostArk.html">Lost Ark</a></td>
            <td class="game-name"><a href="EldenRing.html">Elden Ring</a></td>
        </tr>
        <tr>
            <td class="game-info">Price: £49.99</td>
            <td class="game-info">Price: £13.99</td>
            <td class="game-info">Price: £59.99</td>
        </tr>
        <tr>
            <td><button class="add-to-basket" onclick="addToBasket('Rust', 49.99)">Add to Basket</button></td>
            <td><button class="add-to-basket" onclick="addToBasket('Lost Ark', 13.99)">Add to Basket</button></td>
